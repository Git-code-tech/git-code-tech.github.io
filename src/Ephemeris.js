...
export default class Ephemeris {
  ...
  getString() {
        ...
        var moon = "(" + this.moon.position.shapeDirectionString + "," + this.moon.position.shapeString + "," + this.moon.position.quarterApproximationDirectionString + "," + (this.moon.position.quarterApproximationString || this.moon.position.shapeDirectionString + this.moon.position.shapeString) + "," + this.moon.position.illuminatedFraction + "," + this.moon.position.phaseDecimal + "," + this.moon.orbit.meanAscendingNode.apparentLongitude + "," + this.moon.orbit.meanDescendingNode.apparentLongitude + "," + this.moon.orbit.meanPerigee.apparentLongitude + "," + this.moon.orbit.meanApogee.apparentLongitude + ")";
        _valu += moon;
        console.log(_valu);
        return _valu;
    }
